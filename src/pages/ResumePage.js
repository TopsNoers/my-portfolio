...
const ParallaxIfMobile = ({ isMobile, y, className, children }) => {
  if (!isMobile) return <>{children}</>;
  return (
    <Parallax y={y} className={className}>
      {children}
    </Parallax>
  );
};
  ...
  return (
    <>
      ...
      <div className="page-content resume-page">
        ...
        <ParallaxIfMobile isMobile={isMobile} y={[-15, 15]} className="parallax-title">
          <h2 className="page-title">Resume</h2>
        </ParallaxIfMobile>

        <ParallaxIfMobile isMobile={isMobile} y={[-10, 10]} className="parallax-section">
          <div className="resume-section">
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <p>
                  SMKN 2 Subang is a vocational school known for offering a wide range of technical and vocational programs. One of its key departments is Software Engineering, which focuses on teaching students the skills needed to design, develop, and maintain software applications.
                </p>
              </div>
            </div>
            ...
            <div className="timeline-item">
              ...
              <div className="timeline-content">
                ...
                <p>
                  University of Subang is a public university located in Subang, Jawa Barat, Indonesia. It was established in 1976. The university offers a wide range of programs, including undergraduate, graduate, and postgraduate.
                </p>
              </div>
            </div>
          </div>
        ...
        <ParallaxIfMobile isMobile={isMobile} y={[-8, 8]} className="parallax-section">
          <div className="resume-section">
            <h3 className="section-title">Experience</h3>

            <div className="timeline-item">
              <div className="timeline-date">Sep 2022 - Sep 2025</div>
              <div className="timeline-content">
            ...
            <div className="timeline-item">
              <div className="timeline-date">2025 - Current</div>
              <div className="timeline-content">
                <h4>PT. TKG Taekwang Indonesia</h4>
                <p className="timeline-subtitle">Software Engineer (Modernize Manufactur)</p>
                <p className="timeline-location">Subang, Indonesia</p>
                <ul className="timeline-achievements">
                  <li>Developed a new feature for the company's website using Laravel and Tailwind CSS, including database design, API development, and user interface.</li>
                </ul>
              </div>
            </div>
        ...
        <ParallaxIfMobile isMobile={isMobile} y={[-6, 6]} className="parallax-section">
          <div className="resume-section">
        ...
        <ParallaxIfMobile isMobile={isMobile} y={[-4, 4]} className="parallax-section">
          <div className="resume-section">
        ...
        <ParallaxIfMobile isMobile={isMobile} y={[-2, 2]} className="parallax-section">
          <div className="resume-section">
